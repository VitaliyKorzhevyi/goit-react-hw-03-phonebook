...
export class App extends Component {
  ...
  handleFormSubmit = (values, { resetForm }) => {
    const contact = { id: nanoid(), ...values }; //Створює новий контактний об'єкт, використовуючи значення, отримані з форми, і генерує унікальний ідентифікатор контакту за допомогою функції nanoid.
  ...
  //викликається при зміні значення поля фільтрації. Він отримує нове значення поля та встановлює його в поле filter стану компонента за допомогою методу setState.
